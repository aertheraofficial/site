...
import { accessibilitySections } from "@/data/site";

export const metadata: Metadata = {
  title: "Accessibility Statement",
  description:
    "Aerthera accessibility statement covering accessibility goals, current measures, and support contact details.",
};
        ...
        <div className="page-frame">
          <div className="content-shell py-16 sm:py-20">
            ...
            <p className="mt-5 max-w-2xl text-[1rem] leading-8 text-[#5d574f]">
              Our current accessibility commitment for browsing, shopping, and
              completing checkout on the Aerthera storefront.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="page-frame py-12 sm:py-16">
        <div className="content-shell space-y-6">
          {accessibilitySections.map((section) => (
            ...
            >
              <h2 className="text-[1.15rem] font-semibold text-[#201d17]">{section.title}</h2>
